...
{
    internal class HtmlFormat_PtBrCompare : HtmlFormat_Abstract
    {
        public HtmlFormat_PtBrCompare(Parameters parameters) : base(parameters)
        {
        }

        protected class LineFormat : LineFormatParameters
        {
 
            public override void SetData(Paragraph englishParagraph, Paragraph ptAlternative, string htmlHelpTranslation, string htmlCompare)
            {
